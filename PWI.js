...
function familiarIntroRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of familiarIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function NamingIntroRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of NamingIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceTrialInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practiceTrialInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function TrialInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of TrialInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trial_2LoopBegin(Trial_2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrial_2 of Trial_2) {
...
function Trial_3LoopBegin(Trial_3LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrial_3 of Trial_3) {
...
function Trial_4LoopBegin(Trial_4LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrial_4 of Trial_4) {
...
function Trial_Set_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trial_Set_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function betweentrialbreakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of betweentrialbreakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function NewSetBeginRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of NewSetBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trial_Set_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trial_Set_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trial_Set_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trial_Set_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trial_Set_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trial_Set_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
